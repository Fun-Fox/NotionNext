const CONFIG = {
  ...
  MAGZINE_SOCIAL_CARD_TITLE_2: '加入频道讨论分享',
  MAGZINE_SOCIAL_CARD_TITLE_3: '点击加入频道',
  MAGZINE_SOCIAL_CARD_URL: 'https://pd.qq.com/s/9q4qy35ad?b=9',
  ...
  MAGZINE_FOOTER_LINKS: [
    {
      name: '开发者',
      menus: [
        { title: 'Github', href: 'https://github.com/Fun-Fox' },
      ]
    },
  ],
